...
data class IptvUiState(
    ...
    val sportEvents: List<MatchedSportEvent> = emptyList(),
    val espnEvents: List<EspnProcessedEvent> = emptyList(),
    val matchedEspnEvents: List<MatchedSportEvent> = emptyList(),
    val sportLoading: Boolean = false,
    val tvShows: List<MatchedTvShow> = emptyList(),
    val tvLoading: Boolean = false,
    val ufcEvents: List<EspnProcessedEvent> = emptyList(),
